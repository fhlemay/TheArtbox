...
$oeuvres = [
    [
        'id' => '1',
        'imageFile' => 'clark-van-der-beken',
        'title' => 'Dodomu',
        'description' => 'Mia Tozerski',
        'descriptionComplete' => "Mia Tozerski est une artiste peintre ukrainienne réfugiée de la guerre. Sur cette œuvre, Dodomu (\"domicile\" en ukrainien), elle nous montre la tristesse du peuple ukrainien qu'elle partage, ayant elle-même dû quitter son foyer. L'œuvre évoque le drapeau liquéfié d'une Ukraine en souffrance, pleurant la mort de ses compatriotes. Ce travail chargé d'émotion est le symbole d'un événement qui marquera l'Histoire. Cette peinture à l'acrylique rayonne grâce à son fond lisse et ses mélanges de couleurs éclatantes.",
    ],
    [
        'id' => '2',
        'imageFile' => 'pawel-czerwinski-3',
        'title' => 'Aashaaheen Baadal',
        'description' => 'Anaisha Devi',
        'descriptionComplete' => 'Sur cette oeuvre conceptuelle à la fois organique, minérale et liquide, Anaisha Devi nous transporte dans un nuage noir envoûtant. Un sombre tableau qui, par son verni éclatant, rayonne tel un marbre poli. Une oeuvre à la cohérence transcendantale, exécutée à la perfection.',
    ],
    [
        'id' => '3',
        'imageFile' => 'dan-cristian-padure',
        'title' => 'Nightlife Traffic',
        'description' => 'Andrew Forsythe',
        'descriptionComplete' => 'Quisque accumsan ultrices ligula vestibulum posuere. Aliquam feugiat ligula eget massa blandit condimentum. Morbi volutpat erat luctus suscipit pellentesque. Quisque cursus tempor nibh at sollicitudin. Sed blandit libero velit. Etiam tincidunt facilisis mollis. Ut mollis nunc sit amet lacinia luctus. Suspendisse volutpat enim semper arcu rutrum, et iaculis risus interdum. Duis at libero.',
    ],
    [
        'id' => '4',
        'imageFile' => 'steve-johnson-5',
        'title' => "Le refuge de l'Havre",
        'description' => 'Simon Pelletier',
        'descriptionComplete' => 'Nam tempus neque nec felis venenatis auctor. Nam velit risus, lobortis eu quam non, interdum efficitur nibh. Phasellus a augue ac orci lacinia mattis et vel lectus. Sed nec tellus urna. Donec at turpis turpis. Cras quam tellus, imperdiet vitae finibus id, varius quis felis. Maecenas blandit eleifend risus, vel hendrerit erat dignissim id. Nullam at laoreet nibh. Nulla gravida varius sollicitudin. Etiam non aliquam diam, tempor varius sapien. Aenean et velit eu nisi lobortis massa nunc.',
    ],
    [
        'id' => '5',
        'imageFile' => 'steve-johnson',
        'title' => 'Red Washover',
        'description' => 'Kit Van Der Borght',
        'descriptionComplete' => 'Nunc euismod ullamcorper tortor, id efficitur ante interdum in. Integer eu condimentum nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Cras viverra suscipit feugiat. Mauris vehicula luctus tellus, eu hendrerit libero laoreet ut. In tristique vehicula nisl in tempus. Morbi tempus aliquet gravida. In eget est congue, rhoncus sapien at, cursus metus.',
    ],
    [
        'id' => '6',
        'imageFile' => 'pawel-czerwinski',
        'title' => 'Chromatics',
        'description' => 'Jean-Michel Delatronchette',
        'descriptionComplete' => 'Vivamus commodo non libero at hendrerit. In lacinia dui sit amet pellentesque iaculis. Donec at ultricies sem porttitor.',
    ],
    [
        'id' => '7',
        'imageFile' => 'jazmin-quaynor',
        'title' => 'Digital Negative',
        'description' => 'Hamish McKee',
        'descriptionComplete' => 'Integer in nisl posuere, pulvinar ex ac, tincidunt risus. Nullam vel lorem et leo dignissim accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempor, magna non consectetur dapibus, est libero iaculis lacus, eget semper turpis orci vitae felis. Fusce eget molestie.',
    ],
    [
        'id' => '8',
        'imageFile' => 'steve-johnson-6',
        'title' => 'Blast from the past',
        'description' => 'Juliette Baskerville',
        'descriptionComplete' => 'Nunc fermentum purus dapibus justo fermentum auctor. Maecenas non tincidunt leo. Morbi vitae iaculis sem. Donec quis scelerisque massa. Fusce quis accumsan diam, et interdum lectus. Suspendisse mattis pulvinar vehicula. Duis nisi. ',
    ],
    [
        'id' => '9',
        'imageFile' => 'victor-grabarczyk',
        'title' => 'Hurricane',
        'description' => 'Natalie Wellington',
        'descriptionComplete' => 'Aliquam tristique tempus molestie. Nulla nisl eros, dapibus eu lectus in, cursus accumsan arcu. Suspendisse bibendum diam dignissim porta maximus. Praesent sollicitudin consectetur faucibus. Cras pulvinar massa a orci rutrum, id blandit enim viverra. Praesent sed congue augue. Suspendisse efficitur, nisl quis finibus faucibus, lacus felis bibendum leo, eu euismod lacus mauris in felis. Quisque dignissim et dui et aliquet. Donec ut lobortis eros, vitae tincidunt augue metus. ',
    ],
    [
        'id' => '10',
        'imageFile' => 'pawel-czerwinski-2',
        'title' => 'La marée rouge',
        'description' => 'Martin Rodriguez',
        'descriptionComplete' => 'Vivamus quis odio vel ligula feugiat facilisis. Donec eleifend pellentesque massa, ut malesuada est bibendum sit amet. Morbi tincidunt nec tellus vel ornare. Mauris dolor tellus, gravida eget euismod eu, viverra eget urna. Phasellus feugiat ipsum nec lorem accumsan, sed porta quam dictum massa nunc. ',
    ],
    [
        'id' => '11',
        'imageFile' => 'steve-johnson-2',
        'title' => 'Asimilacion',
        'description' => 'Angel Sanchez-Fernandez',
        'descriptionComplete' => 'Mauris ut justo ac mi pretium eleifend. Curabitur sed magna ut elit facilisis pharetra. Maecenas tincidunt fermentum ipsum ut sollicitudin. Nullam feugiat, neque vel egestas sollicitudin, quam leo mattis mauris, in lacinia sem mi id risus. Nullam ultrices quam eu leo auctor tempus. Fusce vestibulum mi ex, vel ultricies purus mollis sollicitudin. Aenean ac vehicula ipsum. Nam turpis ante, ultrices eget odio sed, luctus bibendum mauris sodales sed. ',
    ],
    [
        'id' => '12',
        'imageFile' => 'fly-d',
